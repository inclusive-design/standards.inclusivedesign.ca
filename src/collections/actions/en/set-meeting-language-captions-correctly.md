...
quick: |-
  ...
  - If the group is using the chat function, put key words, names, and links in the chat.
  - Save, check and share the transcript after the meeting.
longterm: ''
moreInformation: |-
...
examples: "- [International Organization for Standardization (ISO)](https://www.iso.org/standard/69060.html?utm_source=chatgpt.com)'s organizers confirm the meeting language, test captioning and interpretation settings, and provide key terminology before an international committee meeting, so automated captions and interpreters are more accurate."
relatedActions:
  - 2ac90c88
  - 594d9a28
barriers:
