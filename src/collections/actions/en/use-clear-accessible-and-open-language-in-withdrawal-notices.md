...
title: Use clear, accessible, and open language in withdrawal notices
uuid: 5a7ef076
draft: false
quick: ''
longterm: |-
...
moreInformation: |-
  - [W3C](https://www.w3.org/WAI/cognitive/)’s cognitive accessibility guidance recognizes clear language as an important part of accessibility. Information should be understandable, predictable, and presented in ways that reduce unnecessary cognitive effort.
  ...
  - The [Federal Plain Language Guidelines](https://digital.gov/guides/plain-language/principles) provide practical techniques for making information easier to understand, including organizing content clearly, using familiar words, and explaining technical language.
examples: |-
