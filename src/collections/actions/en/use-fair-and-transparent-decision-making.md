...
examples: |-
  - [Germany – DIN](https://www.din.de/en)[ ](https://www.din.de/en)uses a comment resolution matrix that is publicly shared after consultation, showing how input was handled. DIN includes diverse stakeholder representatives when making decisions to balance perspectives and reduce majority-rule bias.
