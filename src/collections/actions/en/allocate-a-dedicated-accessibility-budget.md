...
moreInformation: |-
  ...
  - [Budgeting for Access ](chrome-extension://efaidnbmnnnibpcajpcglclefindmkaj/https://vera-institute.files.svdcdn.com/production/downloads/publications/budgeting-for-access-updated.pdf)is a practical source you can use to support the idea that access needs should be planned and funded, not treated as optional extras.
examples: |-
